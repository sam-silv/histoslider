  ...
  render () {
    ...
    return (
      <div style={Object.assign(histosliderStyle, { width: this.props.width })} className='Histoslider Histoslider-wrapper'>
        <Histogram {...Object.assign({}, this.props, { start, end, extent, selection: selectionSorted, innerWidth, scale, height: this.props.histogramHeight })} />
        <Slider {...Object.assign({}, this.props, { start, end, extent, selection, selectionSorted, scale, innerWidth, height: this.props.height - this.props.histogramHeight })} />
      </div>
    )
  }
}
