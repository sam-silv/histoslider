          ...
          <g transform={'translate(0,' + this.props.height + ')'}>
            <g transform='scale(1,-1)'>
            {
              buckets.map((bucket, i) => {
                return <rect fill='red' key={i} width={bucketWidth - this.props.histogramPadding} height={(bucket.values.length / max) * this.props.height} x={i * bucketWidth + (this.props.histogramPadding / 2)} />
              })
            }
            </g>
          </g>
